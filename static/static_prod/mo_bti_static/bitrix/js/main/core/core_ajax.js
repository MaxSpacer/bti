...
{
	return BX.ajax.loadJSON('https://mobti.ru/bitrix/tools/ajax_captcha.php', callback);
};
...
BX.ajax.runAction = function(action, config)
{
	...
	var url = 'https://mobti.ru/bitrix/services/main/ajax.php?' + BX.ajax.prepareData(getParameters);
	...
	checkRedirectFinish: function(param_name, param_value)
	{
		...
		BX.ready(function ()
		{
			...
			if (test == 'view/' || test == 'view%')
			{
				...
				var url = 'https://mobti.ru/bitrix/tools/ajax_redirector.php?hash=' + current_hash;
